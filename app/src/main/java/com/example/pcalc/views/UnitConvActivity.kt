package com.example.pcalc.views
...
import com.example.pcalc.MainActivity
import com.example.pcalc.R
import com.example.pcalc.component.SpinnerItemAdapter
import com.example.pcalc.model.ConverterPref
import com.example.pcalc.model.UnitConvViewModel
import com.example.pcalc.utils.getModesList
import com.example.pcalc.utils.showThemeDialog
import com.example.pcalc.views.fragments.*
import com.example.pcalc.views.fragments.adapters.ViewPagerAdapter
import java.io.File
...
class UnitConvActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when(item_id){
            ...
            R.id.helpopt -> {
                val helpuri = Uri.parse("https://github.com/saipraneeth0852")
